...
{
    c.SwaggerDoc("v1", new() { Title = "M�moire Nomade API", Version = "v1" });
...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ClockSkew = TimeSpan.Zero // Sin margen extra de expiraci�n
    };
});

builder.Services.AddAuthorization();

// Configuraci�n JWT y Refresh Token desde appsettings
